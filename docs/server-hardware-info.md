...
| data | An array of [Hardware Info](hardware-info.md) objects, each representing information about each PCI and USB hardware device on the system this application is running on | Array |