...
| data | An array of [Disk Drive Info](objects/disk-drive-info.md) objects, each representing information about each disk drive on the system this application is running on | Array |
