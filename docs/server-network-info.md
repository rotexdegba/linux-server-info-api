...
| data | An array of [Network Info](network-info.md) objects, each representing information about each network interface device on the system this application is running on | Array |