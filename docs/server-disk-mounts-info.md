...
| data | An array of [Disk Mount Info](objects/disk-mount-info.md) objects, each representing information about each disk mount on the system this application is running on | Array |
